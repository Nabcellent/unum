        ...
        <div class="panel mb-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <select x-ref="tomGradesEl" x-model="learning_area_id" aria-label @change="fetchStrands">
                ...
                <div>
                    ...
                    <select x-ref="tomStrandEl" x-model="form.strand_id" aria-label @change="fetchSubStrands">
                ...
                <div class="table-responsive">
                    <table class="table-hover">
                        ...
                        <template x-for="s in sub_strands" :key="s.id">
                            <tr>
                                <td x-text="s.name" class="max-w-[18rem]"></td>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data("subStrands", () => ({
                ...
                init() {
                    ...
                    this.tomLearningArea = new TomSelect(this.$refs.tomGradesEl, tomOpts);
                            ...
                            .then(({data: {data, status}}) => {
                                if (status) {
                                    ...
                                    this.strands = data.map(s => {
                                        ...
                                        return {...s, selected: s.id === this.form.strand_id}
                                    })
                ...
                fetchSubStrands() {
                    if (this.form.strand_id) {
                        axios.get(`/api/strands/${this.form.strand_id}/sub-strands`).then(({data: {data, status}}) => {
                            if (status) this.sub_strands = data
                        })
                    }
                },
                onCreate() {
                ...
                onEdit(subStrand) {
                    ...
                    this.tomStrand.addItem(subStrand.strand_id, true)
                    this.tomLearningArea.addItem(this.learning_area_id, true)
