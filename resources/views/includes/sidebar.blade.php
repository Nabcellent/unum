                    ...
                    <ul>
                        ...
                        <li class="menu nav-item">
                            <button
                                type="button"
                                class="nav-link group"
                                :class="{'active' : activeDropdown === 'summaries'}"
                                @click="activeDropdown === 'summaries' ? activeDropdown = null : activeDropdown = 'summaries'"
                            >
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'summaries'}">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                              stroke-linecap="round" stroke-linejoin="round"/>
